		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
		      <ul class="nav navbar-nav">
		        <!-- <li><a href="#"><font color="black"><strong>xxxx</strong></font></a></li> -->
		        <!-- <li><a href="#"><font color="black"><strong>YYYY</strong></font></a></li> -->
		        <!-- <li><a href="#"><font color="red"><strong>DDDD</strong></font></a></li> -->
		        <li><a href="${pageContext.request.contextPath}/blogger/aboutMe.html"><font color="black"><strong>关于博主</strong></font></a></li>
		        <%--<li><a href="${pageContext.request.contextPath}/download.html"><font color="black"><strong>简介</strong></font></a></li>--%>
		      </ul>
